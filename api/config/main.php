...
$config = [
    ...
    'modules' => [
        ...
        'v2' => [
            'class' => 'api\versions\v2\ApiModule2',
            'components' => [
                'baseUser' => [
                    'class' => \api\versions\v2\components\user\BaseUserComponent::class,
                    'user_model' => \common\models\localRecord\User::class,
                    'api_formatter' => \api\versions\v2\models\requestModels\user\APIFormatter::class
                ],
                'user' => [
                    'class' => \api\versions\v2\components\user\UserComponent::class,
                    'user_model' => \common\models\localRecord\User::class,
                    'api_formatter' => \api\versions\v2\models\requestModels\user\APIFormatter::class
                ],
                'profile' => [
                    'class' => \api\versions\v2\components\user\ProfileComponent::class,
                    'user_model' => \common\models\localRecord\User::class,
                    'api_formatter' => \api\versions\v2\models\requestModels\user\APIFormatter::class
                ],
                'checkVerification' => [
                    'class'         => \api\versions\v2\components\CheckVerification::class,
                    'check'         => \api\versions\v2\models\requestModels\check\Check::class,
                    'api_formatter' => \api\versions\v2\models\requestModels\check\ApiFormatter::class
                ],
